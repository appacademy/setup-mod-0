...
Please follow the appropriate guide (PC, Mac, or Linux) to set up your development environment on
your operating system.  While there are contractually obligated minimum
requirements for hardware and operating system for the main program, you may
complete the prepwork on any computer in which you are able to install and use
